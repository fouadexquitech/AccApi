...
{
    [Table("tblBOQVOTemp")]
    public partial class TblBoqvotemp
    {
        [Key]
        [Column("boqSeq")]
        ...
        [InverseProperty(nameof(TblOriginalBoqvotemp.TblBoqvotemps))]
        public virtual TblOriginalBoqvotemp BoqItemNavigation { get; set; }
    }
}
