...
{
    [Table("tblOriginalBOQVOTemp")]
    public partial class TblOriginalBoqvotemp
    {
        public TblOriginalBoqvotemp()
        {
            TblBoqvotemps = new HashSet<TblBoqvotemp>();
        }
        ...
        [InverseProperty(nameof(TblBoqvotemp.BoqItemNavigation))]
        public virtual ICollection<TblBoqvotemp> TblBoqvotemps { get; set; }
    }
}
