...
{
    [Table("tblDistribHdr_Temp")]
    [Index(nameof(DisDate), Name = "IX_tblDistribHdr_Temp")]
    [Index(nameof(Dislab), Name = "IX_tblDistribHdr_Temp_1")]
    [Index(nameof(DisProject), Name = "IX_tblDistribHdr_Temp_2")]
    public partial class TblDistribHdrTemp
    {
        [Key]
        [Column("seq")]
