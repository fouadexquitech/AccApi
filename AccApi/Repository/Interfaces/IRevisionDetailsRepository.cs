...
namespace AccApi.Repository.Interfaces
{
    public interface IRevisionDetailsRepository
    {
        ...
        bool UpdateRevisionDetailsPriceByBoq(List<RevisionDetailsList> revisionDetailsList, string CostConn);
        bool UpdateRevisionDetailsPrice(List<RevisionDetailsList> revisionDetailsList, string CostConn);
        ...
        List<C> GetComparisonSheet(int packageId, SearchInput input, int supId, string CostConn, string C);
        ...
        bool ExcludRessource(int packId, string boqResSeq, bool isNewItem, bool isAlternative, bool isExclud, string CostConn);
    }
}
